...
int main() {
    ...
    if (!verifySequence(seq2, "test1", "ACGTACGT")) {
    ...
    if (!verifySequence(seq3, "test1", "ACGTACGT")) {
    ...
    seq1 = test_seq1;
    if (!verifySequence(seq1, "", "ACGTTCGA")) {
    ...
    seq1 = test_seq2;
    if (!verifySequence(seq1, "", "TCGAAGTC")) {
     ...
     */
    seq1 = seq2;
    if (!verifySequence(seq1, "test1", "ACGTACGT")) {
